...
import { ExternalLink, Eye, Save, TerminalSquare, RotateCcw, Github, Twitter, Linkedin, Globe, Link2, Mail, Trash2, Palette, ChevronDown, LogOut, AlertTriangle, Share2, Copy, Check, Settings, ChevronLeft, ChevronRight } from "lucide-react";
import {
  defaultPortfolio,
  loadPortfolio,
  savePortfolio,
